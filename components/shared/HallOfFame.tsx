...
export default function HallOfFame({ currentUser, classes }: HallOfFameProps) {
    ...
    const displayClasses = useMemo(() => {
        // Fix: Role comparison and property access for student user
        if (currentUser.role === 'teacher' || currentUser.role === 'principal') { // Assuming 'student' is not a role, let's handle staff
